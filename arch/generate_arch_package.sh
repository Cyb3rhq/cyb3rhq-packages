...
clean() {
    ...
    # Clean the files
    rm -rf ${DOCKERFILE_PATH}/{*.sh,*.tar.gz,cyb3rhq-*} ${SOURCES_DIRECTORY}
...
help() {
    ...
    echo "    --packages-branch <branch>    [Required] Select Git branch or tag from cyb3rhq-packages repository. e.g ${PACKAGES_BRANCH}"
