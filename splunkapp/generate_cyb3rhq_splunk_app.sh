...
# Program to build the Cyb3rhq App for Splunk
...
BRANCH_TAG=""
SPLUNK_VERSION=""
CONTAINER_NAME="cyb3rhq-splunk-app-builder"
OUTDIR="${CURRENT_PATH}/output"
CHECKSUMDIR=""
REVISION=""
REPOSITORY="cyb3rhq-splunk"
...
build_package() {
    ...
    docker run -t --rm -v ${OUTDIR}:/cyb3rhq_splunk_app:Z \
