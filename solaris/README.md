...
In this repository, you can find the necessary tools to build a Cyb3rhq package for solaris 10 and 11, using scripts or automated using vagrant, and the tools to build a solaris 10 and 11 vagrant box:
