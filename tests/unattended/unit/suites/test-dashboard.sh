...
test-07-dashboard_configure-dist-one-kibana-node-one-elastic-node-assert() {
    dashboard_copyCertificates
    installCommon_getConfig dashboard/dashboard_unattended_distributed.yml /etc/cyb3rhq-dashboard/opensearch_dashboards.yml
}
...
test-09-dashboard_configure-AIO-assert() {
    dashboard_copyCertificates
    installCommon_getConfig dashboard/dashboard_unattended.yml /etc/cyb3rhq-dashboard/opensearch_dashboards.yml
}
