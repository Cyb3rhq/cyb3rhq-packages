...
Conflicts:   ossec-hids ossec-hids-agent cyb3rhq-agent cyb3rhq-local
Obsoletes: cyb3rhq-api < 4.0.0
AutoReqProv: no
...
install -m 0755 src/init/templates/ossec-hids-rh.init ${RPM_BUILD_ROOT}%{_initrddir}/cyb3rhq-manager
mkdir -p ${RPM_BUILD_ROOT}/usr/lib/systemd/system/
sed -i "s:CYB3RHQ_HOME_TMP:%{_localstatedir}:g" src/init/templates/cyb3rhq-manager.service
install -m 0644 src/init/templates/cyb3rhq-manager.service ${RPM_BUILD_ROOT}/usr/lib/systemd/system/
...
if [ -f %{_localstatedir}/queue/db/global.db ]; then
  ...
  chown cyb3rhq:cyb3rhq %{_localstatedir}/queue/db/global.db*
fi
...
if [ $1 = 2 ]; then
  ...
  if [ -f %{_sysconfdir}/ossec-init.conf ]; then
    ...
    # Ask cyb3rhq-control the version
    VERSION=$(%{_localstatedir}/bin/cyb3rhq-control info -v)
  fi
  ...
  if [ "$MAJOR" = "3" ] && [ -d %{_localstatedir}/api ]; then
    if command -v systemctl > /dev/null 2>&1 && systemctl > /dev/null 2>&1 ; then
      ...
      rm -f /etc/systemd/system/cyb3rhq-api.service
    elif command -v service > /dev/null 2>&1 && command -v chkconfig > /dev/null 2>&1; then
      service cyb3rhq-api stop > /dev/null 2>&1
      chkconfig cyb3rhq-api off > /dev/null 2>&1
      chkconfig --del cyb3rhq-api > /dev/null 2>&1
...
if [ $1 = 1 ]; then
  ...
  chown cyb3rhq:cyb3rhq %{_localstatedir}/logs/integrations.log
...
if [[ -d /run/systemd/system ]]; then
  rm -f %{_initrddir}/cyb3rhq-manager
fi

# Generation auto-signed certificate if not exists
if [ ! -f "%{_localstatedir}/etc/sslmanager.key" ] && [ ! -f "%{_localstatedir}/etc/sslmanager.cert" ]; then
  %{_localstatedir}/bin/cyb3rhq-authd -C 365 -B 2048 -S "/C=US/ST=California/CN=Cyb3rhq/" -K %{_localstatedir}/etc/sslmanager.key -X %{_localstatedir}/etc/sslmanager.cert 2>/dev/null
...
chown root:cyb3rhq %{_localstatedir}/ruleset/sca/*
...
if getent group ossec > /dev/null 2>&1; then
  find %{_localstatedir}/ -group ossec -user root -print0 | xargs -0 chown root:cyb3rhq > /dev/null 2>&1 || true
  if getent passwd ossec > /dev/null 2>&1; then
    find %{_localstatedir}/ -group ossec -user ossec -print0 | xargs -0 chown cyb3rhq:cyb3rhq > /dev/null 2>&1 || true
    userdel ossec > /dev/null 2>&1
  fi
  if getent passwd ossecm > /dev/null 2>&1; then
    find %{_localstatedir}/ -group ossec -user ossecm -print0 | xargs -0 chown cyb3rhq:cyb3rhq > /dev/null 2>&1 || true
    userdel ossecm > /dev/null 2>&1
  fi
  if getent passwd ossecr > /dev/null 2>&1; then
    find %{_localstatedir}/ -group ossec -user ossecr -print0 | xargs -0 chown cyb3rhq:cyb3rhq > /dev/null 2>&1 || true
...
%posttrans
if [ -f %{_sysconfdir}/systemd/system/cyb3rhq-manager.service ]; then
  rm -rf %{_sysconfdir}/systemd/system/cyb3rhq-manager.service
...
if [ -f %{_localstatedir}/tmp/cyb3rhq.restart ]; then
  ...
  if command -v systemctl > /dev/null 2>&1 && systemctl > /dev/null 2>&1 ; then
    systemctl daemon-reload > /dev/null 2>&1
    systemctl restart cyb3rhq-manager.service > /dev/null 2>&1
  elif command -v service > /dev/null 2>&1 ; then
    service cyb3rhq-manager restart > /dev/null 2>&1
  else
...
%files
%defattr(-,root,cyb3rhq)
%config(missingok) %{_initrddir}/cyb3rhq-manager
%attr(640, root, cyb3rhq) %verify(not md5 size mtime) %ghost %{_sysconfdir}/ossec-init.conf
/usr/lib/systemd/system/cyb3rhq-manager.service
...
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/api
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/api/configuration
%attr(660, root, cyb3rhq) %config(noreplace) %{_localstatedir}/api/configuration/api.yaml
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/api/configuration/security
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/api/configuration/ssl
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/api/scripts
%attr(640, root, cyb3rhq) %{_localstatedir}/api/scripts/*.py
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/backup
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/backup/db
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/backup/agents
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/backup/shared
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/bin
%attr(750, root, root) %{_localstatedir}/bin/agent_control
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/agent_groups
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/agent_upgrade
%attr(750, root, root) %{_localstatedir}/bin/clear_stats
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/cluster_control
%attr(750, root, root) %{_localstatedir}/bin/manage_agents
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-agentlessd
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-analysisd
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-authd
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-control
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-csyslogd
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-dbd
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-execd
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-integratord
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-logcollector
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-logtest-legacy
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/cyb3rhq-logtest
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-maild
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-monitord
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-regex
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-remoted
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-reportd
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-syscheckd
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/verify-agent-conf
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/cyb3rhq-apid
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/cyb3rhq-clusterd
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-db
%attr(750, root, root) %{_localstatedir}/bin/cyb3rhq-modulesd
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/rbac_control
%attr(750, root, cyb3rhq) %{_localstatedir}/bin/cyb3rhq-keystore
...
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/etc/decoders
%attr(660, cyb3rhq, cyb3rhq) %config(noreplace) %{_localstatedir}/etc/decoders/local_decoder.xml
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/etc/lists
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/etc/lists/amazon
%attr(660, cyb3rhq, cyb3rhq) %config(noreplace) %{_localstatedir}/etc/lists/amazon/*
%attr(660, cyb3rhq, cyb3rhq) %config(noreplace) %{_localstatedir}/etc/lists/audit-keys
%attr(660, cyb3rhq, cyb3rhq) %config(noreplace) %{_localstatedir}/etc/lists/security-eventchannel
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/etc/shared
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/etc/shared/default
%attr(660, cyb3rhq, cyb3rhq) %{_localstatedir}/etc/shared/agent-template.conf
%attr(660, cyb3rhq, cyb3rhq) %config(noreplace) %{_localstatedir}/etc/shared/default/*
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/etc/rootcheck
%attr(660, root, cyb3rhq) %{_localstatedir}/etc/rootcheck/*.txt
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/etc/rules
%attr(660, cyb3rhq, cyb3rhq) %config(noreplace) %{_localstatedir}/etc/rules/local_rules.xml
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/framework
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/framework/python
%{_localstatedir}/framework/python/*
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/framework/scripts
%attr(640, root, cyb3rhq) %{_localstatedir}/framework/scripts/*.py
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq
%attr(640, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq/*.py
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq/core/cluster
%attr(640, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq/core/cluster/*.py
%attr(640, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq/core/cluster/*.json
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq/core/cluster/dapi
%attr(640, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq/core/cluster/dapi/*.py
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/integrations
%attr(750, root, cyb3rhq) %{_localstatedir}/integrations/*
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/lib
%attr(750, root, cyb3rhq) %{_localstatedir}/lib/libcyb3rhqext.so
%attr(750, root, cyb3rhq) %{_localstatedir}/lib/libcyb3rhqshared.so
...
%attr(750, root, cyb3rhq) %{_localstatedir}/lib/libjemalloc.so.2
...
%attr(750, root, cyb3rhq) %{_localstatedir}/lib/libcontent_manager.so
%attr(750, root, cyb3rhq) %{_localstatedir}/lib/libindexer_connector.so
%attr(750, root, cyb3rhq) %{_localstatedir}/lib/librocksdb.so.8
%attr(750, root, cyb3rhq) %{_localstatedir}/lib/librouter.so
%attr(750, root, cyb3rhq) %{_localstatedir}/lib/libvulnerability_scanner.so
...
%attr(660, cyb3rhq, cyb3rhq) %ghost %{_localstatedir}/logs/api.log
%attr(640, cyb3rhq, cyb3rhq) %ghost %{_localstatedir}/logs/integrations.log
%attr(660, cyb3rhq, cyb3rhq) %ghost %{_localstatedir}/logs/ossec.log
%attr(660, cyb3rhq, cyb3rhq) %ghost %{_localstatedir}/logs/ossec.json
%dir %attr(440, root, cyb3rhq) %{_localstatedir}/templates
%attr(0440, root, cyb3rhq) %{_localstatedir}/templates/vd_states_template.json
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/logs/api
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/logs/archives
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/logs/alerts
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/logs/cluster
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/logs/firewall
...
%attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/tmp/%{_vdfilename}
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/queue
%attr(600, root, cyb3rhq) %ghost %{_localstatedir}/queue/agents-timestamp
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/agentless
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/alerts
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/cluster
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/db
...
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/fts
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/rids
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/tasks
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/sockets
%dir %attr(660, root, cyb3rhq) %{_localstatedir}/queue/vd
%dir %attr(660, root, cyb3rhq) %{_localstatedir}/queue/indexer
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/router
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/logcollector
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/queue/keystore
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/ruleset
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/ruleset/sca
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/ruleset/decoders
%attr(640, root, cyb3rhq) %{_localstatedir}/ruleset/decoders/*
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/ruleset/rules
%attr(640, root, cyb3rhq) %{_localstatedir}/ruleset/rules/*
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/.ssh
%dir %attr(750, cyb3rhq, cyb3rhq) %{_localstatedir}/stats
...
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/applications
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/applications/*
...
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/mongodb
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/mongodb/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/nginx
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/nginx/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/oracledb
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/oracledb/*
...
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/15
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/15/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/16
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/16/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/17
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/17/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/18
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/18/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/19
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/19/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/20
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/20/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/21
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/21/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/22
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/22/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/23
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/darwin/23/*
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/debian
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/debian/*
...
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/sunos
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/sunos/*
...
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/ubuntu
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/ubuntu/*
...
%dir %attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/windows
%attr(640, root, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/sca-%{version}-%{release}-tmp/windows/*
...
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/var/db
%attr(660, root, cyb3rhq) %{_localstatedir}/var/db/mitre.db
%dir %attr(770, root, cyb3rhq) %{_localstatedir}/var/download
%dir %attr(770, cyb3rhq, cyb3rhq) %{_localstatedir}/var/multigroups
...
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-5-0-0.html
* Tue Oct 01 2024 support <info@wazuh.com> - 4.10.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-10-0.html
* Thu Aug 15 2024 support <info@wazuh.com> - 4.9.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-9-0.html
* Thu Jul 18 2024 support <info@wazuh.com> - 4.8.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-8-1.html
* Wed Jun 12 2024 support <info@wazuh.com> - 4.8.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-8-0.html
* Thu May 30 2024 support <info@wazuh.com> - 4.7.5
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-7-5.html
* Thu Apr 25 2024 support <info@wazuh.com> - 4.7.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-7-4.html
* Tue Feb 27 2024 support <info@wazuh.com> - 4.7.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-7-3.html
* Tue Jan 09 2024 support <info@wazuh.com> - 4.7.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-7-2.html
* Wed Dec 13 2023 support <info@wazuh.com> - 4.7.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-7-1.html
* Tue Nov 21 2023 support <info@wazuh.com> - 4.7.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-7-0.html
* Tue Oct 31 2023 support <info@wazuh.com> - 4.6.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-6-0.html
* Tue Oct 24 2023 support <info@wazuh.com> - 4.5.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-5-4.html
* Tue Oct 10 2023 support <info@wazuh.com> - 4.5.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-5-3.html
* Thu Aug 31 2023 support <info@wazuh.com> - 4.5.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-5-2.html
* Thu Aug 24 2023 support <info@wazuh.com> - 4.5.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-5.1.html
* Thu Aug 10 2023 support <info@wazuh.com> - 4.5.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-5-0.html
* Mon Jul 10 2023 support <info@wazuh.com> - 4.4.5
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-4-5.html
* Tue Jun 13 2023 support <info@wazuh.com> - 4.4.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-4-4.html
* Thu May 25 2023 support <info@wazuh.com> - 4.4.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-4-3.html
* Mon May 08 2023 support <info@wazuh.com> - 4.4.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-4-2.html
* Mon Apr 24 2023 support <info@wazuh.com> - 4.3.11
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3.11.html
* Mon Apr 17 2023 support <info@wazuh.com> - 4.4.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-4-1.html
* Wed Jan 18 2023 support <info@wazuh.com> - 4.4.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-4-0.html
* Thu Nov 10 2022 support <info@wazuh.com> - 4.3.10
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-10.html
* Mon Oct 03 2022 support <info@wazuh.com> - 4.3.9
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-9.html
* Wed Sep 21 2022 support <info@wazuh.com> - 3.13.6
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-13-6.html
* Mon Sep 19 2022 support <info@wazuh.com> - 4.3.8
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-8.html
* Wed Aug 24 2022 support <info@wazuh.com> - 3.13.5
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-13-5.html
* Mon Aug 08 2022 support <info@wazuh.com> - 4.3.7
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-7.html
* Thu Jul 07 2022 support <info@wazuh.com> - 4.3.6
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-6.html
* Wed Jun 29 2022 support <info@wazuh.com> - 4.3.5
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-5.html
* Tue Jun 07 2022 support <info@wazuh.com> - 4.3.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-4.html
* Tue May 31 2022 support <info@wazuh.com> - 4.3.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-3.html
* Mon May 30 2022 support <info@wazuh.com> - 4.3.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-2.html
* Mon May 30 2022 support <info@wazuh.com> - 3.13.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-13-4.html
* Sun May 29 2022 support <info@wazuh.com> - 4.2.7
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-2-7.html
* Wed May 18 2022 support <info@wazuh.com> - 4.3.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-1.html
* Thu May 05 2022 support <info@wazuh.com> - 4.3.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-3-0.html
* Fri Mar 25 2022 support <info@wazuh.com> - 4.2.6
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-2-6.html
* Mon Nov 15 2021 support <info@wazuh.com> - 4.2.5
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-2-5.html
* Thu Oct 21 2021 support <info@wazuh.com> - 4.2.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-2-4.html
* Wed Oct 06 2021 support <info@wazuh.com> - 4.2.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-2-3.html
* Tue Sep 28 2021 support <info@wazuh.com> - 4.2.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-2-2.html
* Sat Sep 25 2021 support <info@wazuh.com> - 4.2.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-2-1.html
* Mon Apr 26 2021 support <info@wazuh.com> - 4.2.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-2-0.html
* Sat Apr 24 2021 support <info@wazuh.com> - 3.13.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-13-3.html
* Thu Apr 22 2021 support <info@wazuh.com> - 4.1.5
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-1-5.html
* Mon Mar 29 2021 support <info@wazuh.com> - 4.1.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-1-4.html
* Sat Mar 20 2021 support <info@wazuh.com> - 4.1.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-1-3.html
* Mon Mar 08 2021 support <info@wazuh.com> - 4.1.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-1-2.html
* Fri Mar 05 2021 support <info@wazuh.com> - 4.1.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-1-1.html
* Tue Jan 19 2021 support <info@wazuh.com> - 4.1.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-1-0.html
* Mon Nov 30 2020 support <info@wazuh.com> - 4.0.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-0-3.html
* Mon Nov 23 2020 support <info@wazuh.com> - 4.0.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-0-2.html
* Sat Oct 31 2020 support <info@wazuh.com> - 4.0.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-0-1.html
* Mon Oct 19 2020 support <info@wazuh.com> - 4.0.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-4-0-0.html
* Fri Aug 21 2020 support <info@wazuh.com> - 3.13.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-13-2.html
* Tue Jul 14 2020 support <info@wazuh.com> - 3.13.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-13-1.html
* Mon Jun 29 2020 support <info@wazuh.com> - 3.13.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-13-0.html
* Wed May 13 2020 support <info@wazuh.com> - 3.12.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-12-3.html
* Thu Apr 9 2020 support <info@wazuh.com> - 3.12.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-12-2.html
* Wed Apr 8 2020 support <info@wazuh.com> - 3.12.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-12-1.html
* Wed Mar 25 2020 support <info@wazuh.com> - 3.12.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-12-0.html
* Mon Feb 24 2020 support <info@wazuh.com> - 3.11.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-11-4.html
* Wed Jan 22 2020 support <info@wazuh.com> - 3.11.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-11-3.html
* Tue Jan 7 2020 support <info@wazuh.com> - 3.11.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-11-2.html
* Thu Dec 26 2019 support <info@wazuh.com> - 3.11.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-11-1.html
* Mon Oct 7 2019 support <info@wazuh.com> - 3.11.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-11-0.html
* Mon Sep 23 2019 support <support@wazuh.com> - 3.10.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-10-2.html
* Thu Sep 19 2019 support <support@wazuh.com> - 3.10.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-10-1.html
* Mon Aug 26 2019 support <support@wazuh.com> - 3.10.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-10-0.html
* Thu Aug 8 2019 support <support@wazuh.com> - 3.9.5
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-9-5.html
* Fri Jul 12 2019 support <support@wazuh.com> - 3.9.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-9-4.html
* Tue Jul 02 2019 support <support@wazuh.com> - 3.9.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-9-3.html
* Tue Jun 11 2019 support <support@wazuh.com> - 3.9.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-9-2.html
* Sat Jun 01 2019 support <support@wazuh.com> - 3.9.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-9-1.html
* Mon Feb 25 2019 support <support@wazuh.com> - 3.9.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-9-0.html
* Wed Jan 30 2019 support <support@wazuh.com> - 3.8.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-8-2.html
* Thu Jan 24 2019 support <support@wazuh.com> - 3.8.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-8-1.html
* Fri Jan 18 2019 support <support@wazuh.com> - 3.8.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-8-0.html
* Wed Nov 7 2018 support <support@wazuh.com> - 3.7.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-7-0.html
* Mon Sep 10 2018 support <info@wazuh.com> - 3.6.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-6-1.html
* Fri Sep 7 2018 support <support@wazuh.com> - 3.6.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-6-0.html
* Wed Jul 25 2018 support <support@wazuh.com> - 3.5.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-5-0.html
* Wed Jul 11 2018 support <support@wazuh.com> - 3.4.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-4-0.html
* Mon Jun 18 2018 support <support@wazuh.com> - 3.3.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-3-1.html
* Mon Jun 11 2018 support <support@wazuh.com> - 3.3.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-3-0.html
* Wed May 30 2018 support <support@wazuh.com> - 3.2.4
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-2-4.html
* Thu May 10 2018 support <support@wazuh.com> - 3.2.3
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-2-3.html
* Mon Apr 09 2018 support <support@wazuh.com> - 3.2.2
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-2-2.html
* Wed Feb 21 2018 support <support@wazuh.com> - 3.2.1
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/rerlease-3-2-1.html
* Wed Feb 07 2018 support <support@wazuh.com> - 3.2.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-2-0.html
* Thu Dec 21 2017 support <support@wazuh.com> - 3.1.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-1-0.html
* Mon Nov 06 2017 support <support@wazuh.com> - 3.0.0
- More info: https://cyb3rhq.github.io/documentation/current/release-notes/release-3-0-0.html
