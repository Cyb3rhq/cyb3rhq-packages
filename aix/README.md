Cyb3rhq RPM packages for IBM AIX
==============================

In this repository, you can find the necessary tools to build a Cyb3rhq package for AIX.

## Building AIX packages

Please, visit the following link for the full AIX packages building documentation: [Generate Cyb3rhq AIX packages.](https://cyb3rhq.github.io/documentation/current/development/packaging/generate-aix-package.html)
