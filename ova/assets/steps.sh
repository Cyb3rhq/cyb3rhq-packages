...
systemConfig() {
  ...
  mv ${CUSTOM_PATH}/grub/cyb3rhq.png /boot/grub2/
  ...
  # Update Cyb3rhq indexer jvm heap
  ...
  # Change root password (root:cyb3rhq)
  ...
  bash ${CUSTOM_PATH}/messages.sh ${DEBUG} ${CYB3RHQ_VERSION} ${SYSTEM_USER}
