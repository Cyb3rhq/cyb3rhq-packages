...
find /var/log/cyb3rhq-indexer -type f -execdir sh -c 'cat /dev/null > "$1"' _ {} \;
find /var/log/filebeat -type f -execdir sh -c 'cat /dev/null > "$1"' _ {} \;
find /usr/share/cyb3rhq-dashboard/data/cyb3rhq/logs -type f -execdir sh -c 'cat /dev/null > "$1"' _ {} \;
