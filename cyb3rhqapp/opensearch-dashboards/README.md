# Cyb3rhq OpenSearch Dashboards plugin package

In this repository, you can find the necessary tools to build a Cyb3rhq OpenSearch Dashboards plugin package.

## Building Cyb3rhq plugin for OpenSearch Dashboards packages
