...
# Program to build the Cyb3rhq App for Kibana
...
BRANCH_TAG=""
CHECKSUMDIR=""
CONTAINER_NAME="cyb3rhq-kibana-app-builder"
...
help() {
    ...
    echo "    -s, --store <path>        [Optional] Set the destination path of package, by default /tmp/cyb3rhq-app."
...
build_package(){
    ...
    # Build the Cyb3rhq Kibana app package using the build docker image
